...
// CONCATENATED MODULE: ./src/pages/chuchai/chuchai-autoService.ts
...
var ChuChaiAutoService = (function () {
    function ChuChaiAutoService(http) {
        this.http = http;
        this.labelAttribute = "name";
    }
    ChuChaiAutoService.prototype.getResults = function (keyword) {
    ...
    return ChuChaiAutoService;
}());
ChuChaiAutoService = __decorate([
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"](),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */]])
], ChuChaiAutoService);

//# sourceMappingURL=chuchai-autoService.js.map
// CONCATENATED MODULE: ./src/pages/chuchai/chuchai.ts
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__chuchaiService__ = __webpack_require__(893);
var chuchai___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var chuchai___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
 ...
 */
var ChuchaiPage = (function () {
    function ChuchaiPage(navCtrl, navParams, chuChaiService, chuChaiAutoService, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.chuChaiService = chuChaiService;
        this.chuChaiAutoService = chuChaiAutoService;
    ...
    ChuchaiPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ChuchaiPage');
    };
    ChuchaiPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.storage.get('user')
            .then(function (res) {
            _this.user_id = res.result.res_data.user_id;
            _this.chuChaiService.get_is_department(res.result.res_data.user_id).then(function (result) {
    ...
    ChuchaiPage.prototype.click_me = function () {
        this.inner_type = 'me';
        this.me_list = [];
    ...
    ChuchaiPage.prototype.click_wait_me = function () {
        var _this = this;
        this.inner_type = 'wait_me';
        this.wait_me_list = [];
        this.chuChaiService.get_total_trip(this.user_id, true).then(function (my_data) {
            if (my_data.result.res_data && my_data.result.res_code == 1) {
                _this.wait_me_list = my_data.result.res_data;
            }
        });
    };
    ChuchaiPage.prototype.itemSelected = function (event) {
        var _this = this;
        var type;
        var search_text;
        if (event.id == 1) {
        ...
        this.wait_me_list = [];
        this.chuChaiService.search_trip(type, search_text, this.user_id).then(function (res) {
            if (res.result.res_data && res.result.res_code == 1) {
                _this.wait_me_list = res.result.res_data;
            }
        });
    };
    ChuchaiPage.prototype.itemClearSelected = function (event) {
    ...
    ChuchaiPage.prototype.approval_detail = function (item) {
...
ChuchaiPage = chuchai___decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-chuchai',template:/*ion-inline-start:"/Users/bin/Downloads/OA项目备份/src/pages/chuchai/chuchai.html"*/'<!--\n  Generated template for the VacationApprovalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header no-border>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>出差审核</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content style="background-color:#f0f2f5">\n  <div class="header_div_class">\n      <ion-auto-complete class="searchbar_class" (itemSelected)="itemSelected($event)" (itemClearSelected)="itemClearSelected($event)" [dataProvider]="chuChaiAutoService" showCancelButton="true"></ion-auto-complete>\n  </div>\n      <div *ngIf="inner_type == \'me\'">\n        <div class="div_class" no-lines *ngFor=\'let item of me_list\' tappable (click)=\'approval_detail_no_approve(item)\'>\n          <p text-wrap class="time_class">{{item.create_time}}</p>\n          <span text-wrap class="span_class">{{item.rt_name}}</span> <span style="margin-left:10px">{{item.employee_name}}</span>\n          <p text-wrap class="bottom_class">合计：{{item.total_hours}}h</p>\n          <p text-wrap class="state_class">{{item.state}}</p>\n          <div class="differ_class">\n          </div>\n        </div>\n\n      </div>\n\n      <div no-lines *ngIf="inner_type == \'wait_me\'">\n        <div class="div_class" no-lines *ngFor=\'let item of wait_me_list\' tappable (click)=\'approval_detail(item)\'>\n          <p text-wrap class="time_class">{{item.create_time}}</p>\n          <span text-wrap class="span_class">{{item.rt_name}}</span> <span style="margin-left:10px">{{item.employee_name}}</span>\n          <p text-wrap class="bottom_class">合计：{{item.total_hours}}h</p>\n          <p text-wrap class="state_class">{{item.state}}</p>\n          <div class="differ_class">\n          </div>\n        </div>\n        \n      </div>\n    <div align="center" *ngIf="!wait_me_list || wait_me_list.length == 0">\n      <img style="width:100px;position:absolute;left:calc(50% - 50px);top:calc(50% - 60px)" src="assets/img/nodataimg.png">\n      <p style="width:100px;position:absolute;left:calc(50% - 50px);top:calc(50% + 30px);color:#c2c8cc;font-size:15px">空空如也～</p>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/OA项目备份/src/pages/chuchai/chuchai.html"*/,
        providers: [ChuChaiAutoService, __WEBPACK_IMPORTED_MODULE_4__chuchaiService__["a" /* ChuChaiService */]],
    }),
    chuchai___metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__chuchaiService__["a" /* ChuChaiService */],
        ChuChaiAutoService, __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]])
], ChuchaiPage);

//# sourceMappingURL=chuchai.js.map
// CONCATENATED MODULE: ./src/pages/chuchai/chuchai.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChuchaiPageModule", function() { return ChuchaiPageModule; });
/* harmony import */ var chuchai_module___WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var chuchai_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_auto_complete__ = __webpack_require__(739);
var chuchai_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var ChuchaiPageModule = (function () {
    function ChuchaiPageModule() {
    }
    return ChuchaiPageModule;
}());
ChuchaiPageModule = chuchai_module___decorate([
    chuchai_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            ChuchaiPage,
        ],
        imports: [
            chuchai_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(ChuchaiPage), __WEBPACK_IMPORTED_MODULE_3_ionic2_auto_complete__["a" /* AutoCompleteModule */]
        ],
    })
], ChuchaiPageModule);

//# sourceMappingURL=chuchai.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChuChaiService; });
...
var ChuChaiService = (function () {
    function ChuChaiService(httpservice) {
        this.httpservice = httpservice;
    }
    ChuChaiService.prototype.get_is_department = function (employee_id) {
        var body = JSON.stringify({
            employee_id: employee_id,
        });
        return this.httpservice.postBodyNoLoading("get_is_department", body);
    };
    ChuChaiService.prototype.get_total_trip = function (user_id, need_approve) {
        var body = JSON.stringify({
            user_id: user_id,
    ...
    ChuChaiService.prototype.pass_trip = function (user_id, vacation_id, remark) {
        var body = JSON.stringify({
            user_id: user_id,
    ...
    ChuChaiService.prototype.refuse_trip = function (user_id, vacation_id, remark) {
        var body = JSON.stringify({
            user_id: user_id,
            vacation_id: vacation_id,
            remark: remark,
    ...
    ChuChaiService.prototype.search_trip = function (type, search_text, user_id) {
        var body = JSON.stringify({
            type: type,
    ...
    return ChuChaiService;
}());
ChuChaiService = __decorate([
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"](),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__providers_HttpService__["a" /* HttpService */]])
], ChuChaiService);

//# sourceMappingURL=chuchaiService.js.map
