...
GongdanChoosePeoplePage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-gongdan-choose-people',template:/*ion-inline-start:"/Users/bin/Downloads/OA项目备份/src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.html"*/'<!--\n  Generated template for the GongdanChoosePeoplePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>选择@的人</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)=\'confirm()\'>\n        确定\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ion-searchbar placeholder = "搜索" (ionInput)="getItems($event)"></ion-searchbar>\n    <div style="overflow:scroll;margin-top:2px;">\n    <ion-list>\n      <ion-item tappable (click) = "itemSelect(item)" *ngFor = \'let item of employeeList\'>\n        <ion-avatar item-start>\n            <img src={{item.image}}>\n        </ion-avatar>\n        <h2>{{item.name}}</h2>\n        <p>{{item.job_id.name}}</p>\n        <img *ngIf="is_select(item)" item-end style="float:right;width:18px;" src="assets/img/work_bench/checkbox_true.png">\n      </ion-item>\n  </ion-list>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/OA项目备份/src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__gongdanService__["a" /* GongDanService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__gongdanService__["a" /* GongDanService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["E" /* ToastController */],
...
GongdanChoosePeoplePageModule = gongdan_choose_people_module___decorate([
    gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(GongdanChoosePeoplePage),
        ],
    })
