...
// CONCATENATED MODULE: ./src/pages/chuchai/chuchai-detail/chuchai-detail.ts
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chuchaiService__ = __webpack_require__(893);
 ...
 */
var ChuchaiDetailPage = (function () {
    function ChuchaiDetailPage(navCtrl, navParams, chuchaiService, storage, toastCtrl, alertCtrl) {
        var _this = this;
    ...
    ChuchaiDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ChuchaiDetailPage');
    };
    ChuchaiDetailPage.prototype.click_confirm = function () {
        var _this = this;
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function (data) {
                        // cordova.plugins.Keyboard.close();
                        if (data.title) {
                            _this.chuchaiService.pass_trip(_this.user.user_id, _this.data.vacation_id, data.title).then(function (res) {
                            ...
                            _this.chuchaiService.pass_trip(_this.user.user_id, _this.data.vacation_id, false).then(function (res) {
                                if (res.result && res.result.res_code == 1) {
                                    __WEBPACK_IMPORTED_MODULE_4__providers_Utils__["a" /* Utils */].toastButtom("操作成功", _this.toastCtrl);
                                    _this.navCtrl.pop();
                                }
    ...
    ChuchaiDetailPage.prototype.click_refuse = function () {
        var _this = this;
        var ctrl = this.alertCtrl;
        ctrl.create({
            title: '提示',
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function (data) {
                        // cordova.plugins.Keyboard.close();
                        if (data.title) {
                            _this.chuchaiService.refuse_trip(_this.user.user_id, _this.data.vacation_id, data.title).then(function (res) {
                                if (res.result && res.result.res_code == 1) {
                                    __WEBPACK_IMPORTED_MODULE_4__providers_Utils__["a" /* Utils */].toastButtom("操作成功", _this.toastCtrl);
                                    _this.navCtrl.pop();
                                }
...
var ChuchaiDetailPageModule = (function () {
    function ChuchaiDetailPageModule() {
    }
    return ChuchaiDetailPageModule;
}());
ChuchaiDetailPageModule = chuchai_detail_module___decorate([
    chuchai_detail_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            ChuchaiDetailPage,
        ],
        imports: [
            chuchai_detail_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* IonicPageModule */].forChild(ChuchaiDetailPage),
        ],
    })
], ChuchaiDetailPageModule);

//# sourceMappingURL=chuchai-detail.module.js.map
