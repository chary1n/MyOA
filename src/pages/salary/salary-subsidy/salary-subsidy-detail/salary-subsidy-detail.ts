...
/**
 * Generated class for the SalarySubsidyDetailPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-salary-subsidy-detail',
  templateUrl: 'salary-subsidy-detail.html',
  providers: [SalaryService],
})
export class SalarySubsidyDetailPage {
  item
  user_id
  frontPage
  constructor(public navCtrl: NavController, public navParams: NavParams, public salaryService: SalaryService,
    ...
    let body = {
      'subsidy_id': this.item.subsidy_id
    }
    this.salaryService.get_detail_bt(body).then(res => {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SalarySubsidyDetailPage');
  }
