...
@Injectable()
export class NewShenGouService {
    ...
    search_shengou(type,search_text,user_id){
        let body = JSON.stringify({
            search_type:type,
    ...
    search_wait_me_audit(search_type,search_text,user_id){
        let body = JSON.stringify({
    ...
    search_audited(search_type,search_text,user_id){
        let body = JSON.stringify({
            search_type:search_type,
           search_text:search_text,
           user_id:user_id,
