...
/**
 * Generated class for the OldContactPersonPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-old-contact-person',
  templateUrl: 'old-contact-person.html',
  providers: [ContactService, EmployeeService]
})
export class OldContactPersonPage {
  departmentList;
  employeeList;
  showAll;
  origin_data;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad OldContactPersonPage');
  }
